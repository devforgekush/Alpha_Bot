...
from Audify.misc import SUDOERS, db
...
from Audify.utils.stream.autoclear import auto_clean
...
async def unban_assistant(_, callback: CallbackQuery):
    ...
    try:
        ...
        await callback.answer("✅ My assistant ID has been unbanned successfully!\n\n🎵 You can now play songs without any issues.\n\n💖 Thank you!", show_alert=True)
    except Exception as e:
        await callback.answer(f"❌ Failed to unban my assistant ID.\n\n⚠️ I don't have the ban/unban permission in this chat.\n\n📌 Please grant me ban rights so I can unban my assistant.", show_alert=True)
