        ...
        if await is_maintenance() is False:
            if message.from_user.id not in SUDOERS:
                return await message.reply_text(
                    text=f"⚙️ {app.mention} is currently undergoing maintenance!\n\nPlease visit our <a href={SUPPORT_CHAT}>Support Chat</a>💬 to find out the reason behind it.\n\nThank you for your patience and support! We’ll be back soon! ⏳🔧",
                ...
                if not admins:
                    ...
                    if message.from_user.id not in admins:
                        if await is_skipmode(message.chat.id):
                            ...
                            text = f"""<b>Admin rights required! 🔐⚠️</b>

Refresh admin cache via: /reload ♻️🔄

🗳️ {upvote} votes needed to perform this action. ✅"""
        ...
        if await is_maintenance() is False:
            if CallbackQuery.from_user.id not in SUDOERS:
                return await CallbackQuery.answer(
                    f"⚙️ {app.mention} is currently undergoing maintenance!\n\nPlease visit our <a href={SUPPORT_CHAT}>Support Chat</a>💬 to find out the reason behind it.\n\nThank you for your patience and support! We’ll be back soon! ⏳🔧",
                    show_alert=True,
                )
        try:
